...
| `pnpm lint`            | Lints the website with prettier                  |
| `pnpm format`          | Formats the website with prettier                |

## 👀 Want to learn more about Starlight and Astro?
